...
| 502.gcc_r              |        Success |        Success |              ? |              1 |                    ? |
| 503.bwaves_r           |        Success |        Success |              ? |              ? |                    ? |
| 505.mcf_r              |        Success |        Success |              ? |              1 |                    ? |
| 507.cactuBSSN_r        |        Success |        Success |              ? |              1 |                    ? |
| 508.namd_r             |        Success |        Success |              ? |              1 |                    ? |
| 510.parest_r           |        Success |        Success |              ? | Workload Segfault |                    ? |
| 511.povray_r           |        Success |        Success |              ? |              1 |                    ? |
| 519.lbm_r              |        Success |        Success |              ? |              1 |                    ? |
| 520.omnetpp_r          |        Success |        Success |              ? |              1 |                    ? |
| 521.wrf_r              |        Success |        Success |              ? |              x |                    ? |
| 523.xalancbmk_r        |        Success |        Success |              ? |              1 |                    ? |
| 525.x264_r             |        Success |        Success |              ? |              ? |                    ? |
| 526.blender_r          |        Success |        Success |              ? |              x |                    ? |
| 527.cam4_r             |        Success |        Success |              ? |              ? |                    ? |
| 531.deepsjeng_r        |        Success |        Success |              ? |              1 |                    ? |
| 538.imagick_r          |        Success |        Success |              ? |              1 |                    ? |
| 541.leela_r            |        Success |        Success |              ? |              1 |                    ? |
| 544.nab_r              |        Success |        Success |              ? |              1 |                    ? |
| 548.exchange2_r        |        Success |        Success |              ? |              1 |                    ? |
| 549.fotonik3d_r        |        Success |              x |              ? |              x |                    ? |
| 554.roms_r             |        Success |        Success |              ? |              1 |                    ? |
| 557.xz_r               |        Success |        Success |              ? |              1 |                    ? |
| 600.perlbench_s        |        Success |        Success |              ? |              x |                    ? |
| 602.gcc_s              |        Success |        Success |              ? |              1 |                    ? |
| 603.bwaves_s           |        Success |        Success |              ? |              ? |                    ? |
| 605.mcf_s              |        Success |        Success |              ? |              1 |                    ? |
| 607.cactuBSSN_s        |        Success |        Success |              ? |              1 |                    ? |
| 619.lbm_s              |        Success |        Success |              ? |              1 |                    ? |
| 620.omnetpp_s          |        Success |        Success |              ? |              1 |                    ? |
| 621.wrf_s              |        Success |        Success |              ? |              x |                    ? |
| 623.xalancbmk_s        |        Success |        Success |              ? |              1 |                    ? |
| 625.x264_s             |        Success |        Success |              ? |              ? |                    ? |
| 627.cam4_s             | Workload Segfault | Workload Segfault |              ? |          Error |                    ? |
| 628.pop2_s             |        Success |        Success |              ? |              1 |                    ? |
| 631.deepsjeng_s        |        Success |        Success |              ? |              1 |                    ? |
| 638.imagick_s          |        Success |        Success |              ? |              1 |                    ? |
| 641.leela_s            |        Success |        Success |              ? |              1 |                    ? |
| 644.nab_s              |        Success |        Success |              ? |              1 |                    ? |
| 648.exchange2_s        |        Success |        Success |              ? |              1 |                    ? |
| 649.fotonik3d_s        |        Success |        Success |              ? |              1 |                    ? |
| 654.roms_s             |        Success |        Success |              ? |              1 |                    ? |
| 657.xz_s               |        Success |        Success |              ? |              1 |                    ? |
| 996.specrand_fs        |        Success |        Success |        Success |              1 |                    ? |
| 997.specrand_fr        |        Success |        Success |        Success |              1 |                    ? |
| 998.specrand_is        |        Success |        Success |              ? |              1 |                    ? |
| 999.specrand_ir        |        Success |        Success |              ? |              1 |                    ? |
